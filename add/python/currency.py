...
headlabel = tk.Label(Tops, font=('lato black', 19, 'bold'), text='PROJECT AIML-A : Currency Converter ',
					bg='#e6e5e5', fg='black')
...
label1 = tk.Label(root, font=('lato black', 15, 'bold'), text="\t Converted : ", bg="#e6e5e5", fg="black")
